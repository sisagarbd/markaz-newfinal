        ...
        },
        {
          ...
          render: function () {
            return (
              ...
              '<a href="/app/invoice/preview/" data-bs-toggle="tooltip" class="btn btn-icon" data-bs-placement="top" title="Preview Invoice"><i class="icon-base ti tabler-eye icon-md"></i></a>' +
              '<div class="dropdown">' +
