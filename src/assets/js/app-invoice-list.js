        ...
        },
        {
          ...
          render: function () {
            return (
              ...
              '<a href="/app/invoice/preview/" data-bs-toggle="tooltip" class="btn btn-icon btn-text-secondary rounded-pill waves-effect" data-bs-placement="top" title="Preview Invoice"><i class="icon-base ti tabler-eye icon-22px"></i></a>' +
              '<div class="dropdown">' +
