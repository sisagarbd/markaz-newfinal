          ...
          features: [
            ...
            },
            {
              buttons: [
                ...
                {
                  text: `<i class="icon-base ti tabler-plus icon-16px me-0 me-sm-2"></i><span class="d-none d-sm-inline-block">Add New Library</span>`,
                  ...
                  action: function (e, dt, button, config) {
                    window.location.href = '/book/library/add';
                  }
